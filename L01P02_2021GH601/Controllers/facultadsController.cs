...
using L01P02_2021GH601.Models;

namespace L01P02_2021GH601.Controllers
{
    public class facultadsController : Controller
    {
        private readonly notasContext _context;

        public facultadsController(notasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,facultades")] facultad facultad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,facultades")] facultad facultad)
        {
            if (id != facultad.id)
            {
                return NotFound();
